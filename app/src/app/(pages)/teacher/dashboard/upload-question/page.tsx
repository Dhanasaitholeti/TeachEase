...
import FileUpload from "@/app/(pages)/admin/dashboard/assignment/FileUpload";
import Instructions from "@/app/(pages)/admin/dashboard/assignment/Instructions";
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-lightBlue p-6">
      <div className="w-full max-w-screen bg-white bg-opacity-90 backdrop-blur-lg shadow-xl rounded-xl p-10 border border-gray-300">
        ...
        {/* File Upload Section */}
        <FileUpload  redirectPath="/teacher/dashboard/generated-question"/>
